package cloud.rab.bit.mystrom.exporter.controllers;

import cloud.rab.bit.mystrom.exporter.services.MyStromService;
...
public class MetricsController {
    ...
    private List<Metric> addScrapeMetric(Timed<List<Metric>> timed) {
        ...
        Metric scrapeMetric = Metric.builder()
                .name("mystrom_scrape_duration_ms")
                .type("gauge")
                .value(millis)
                .build();
